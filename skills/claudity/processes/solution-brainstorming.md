<!-- Vendored from microsoft/clarity-agent@6b32c43 processes/solution-brainstorming.md — modified per PORTING.md rules R1, R10 -->
...
```bash
python3 "${CLAUDE_PLUGIN_ROOT}/scripts/protocol_status.py" . --record summary.md solution/solution.md solution/solution-summary.md
```
