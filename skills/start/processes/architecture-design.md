<!-- Vendored from microsoft/clarity-agent@6b32c43 processes/architecture-design.md — modified per PORTING.md rules R1, R10 -->
...
```bash
python3 "${CLAUDE_PLUGIN_ROOT}/scripts/protocol_status.py" . --record solution/architecture.md solution/solution-summary.md
```
