...
(tests/test_mailbox.py, MIT License, Copyright (c) Microsoft Corporation).
Modifications per PORTING.md: the clarity_agent package import becomes a
plain-module import (scripts/ is on sys.path via conftest.py).
"""
