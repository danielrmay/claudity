...
(src/clarity_agent/ai_actions/suggestion.py, MIT License,
Copyright (c) Microsoft Corporation). Modifications per PORTING.md:
the API-backend tool handler (handle_record_suggestion, ToolUseBlock)
is dropped; the clarity_agent package imports become sibling-module
imports (mailbox).
"""
...
from mailbox import Mailbox, ensure_suggestion_box, find_protocol_dir
...
def _cli_main() -> None:
    """CLI: python3 scripts/suggestion.py record < input.json
    ...
    parser = argparse.ArgumentParser(
        prog="python3 scripts/suggestion.py",
