...
description: "Human and AI error: user mistakes, operator misconfiguration, cognitive biases, information loss. Launched by Claudity's failure-brainstorming process; not for direct invocation outside it."
tools: Read, Grep, Glob
---
<!-- Vendored from microsoft/clarity-agent@6b32c43 thinkers/human-factors-thinker.md — modified per PORTING.md rules R6, R7, R9, R11, R12 (harness tools → structured return value) -->
...
For each human factors failure identified, include it as a failure block in your structured output. Each failure record contains:
